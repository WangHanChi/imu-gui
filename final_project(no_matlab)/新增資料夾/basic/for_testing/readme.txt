basic MATLAB .NET Assembly (.NET Component)
...
basic_overview.html - HTML overview documentation file for the generated component. It 
                      contains the requirements for accessing the component and for 
                      generating arguments using the MWArray class hierarchy.

basic.xml - This file contains the code comments for the basic component classes and 
                      ...
                      online documentation for the basic component.
